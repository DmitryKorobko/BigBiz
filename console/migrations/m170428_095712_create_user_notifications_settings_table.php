...
/**
 * Handles the creation of table `user_notifications_settings`.
 */
class m170428_095712_create_user_notifications_settings_table extends Migration
{
    private $tableName = '{{%user_notifications_settings}}';
    ...
    public function safeUp()
    {
        ...
        $this->createTable($this->tableName, [
            ...
            'new_reputation'       => $this->integer(1)->defaultValue(1),
        ...
        $this->addForeignKey(
            'fk-user_notifications_settings_user', $this->tableName, 'user_id',
            'user', 'id', 'CASCADE'
        );
    }
    ...
    {
        $this->dropForeignKey('fk-user_notifications_settings_user', $this->tableName);
