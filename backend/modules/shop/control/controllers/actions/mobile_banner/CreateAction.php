...
{
    public $view = '@backend/modules/shop/control/views/mobile_banner/create';
    ...
    public function run()
    {
        /* @var  $modelItem MobileBannerEntity */
        $banner = new MobileBannerEntity();
        $banner->scenario = MobileBannerEntity::SCENARIO_CREATE;

        $postData = Yii::$app->request->post();
        if ($postData) {
            $postData['MobileBannerEntity']['user_id'] = Yii::$app->user->identity->getId();
        } else {
            /** Default value */
