<?php
namespace backend\modules\shop\home\controllers;

use backend\{
    modules\shop\home\controllers\actions\IndexAction, models\BackendUserEntity
};
use yii\{
 ...
 *
 * @package backend\modules\shop\home\controllers
 */
